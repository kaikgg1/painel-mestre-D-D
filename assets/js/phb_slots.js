...
(function () {
  ...
  const TIPO = {
    ...
    'bruxo':       'pact',
    // Sem slots padrão (Eldritch Knight / Arcane Trickster são 1/3 caster — manual por enquanto)
  ...
  // Retorna { 1: max, 2: max, ..., 9: max } com os valores fixos da classe.
  // Para não-conjuradores, retorna null.
  function porClasse(classe, nivel) {
  ...
  function tipoDaClasse(classe) {
    return TIPO[chave(classe)] || null;
  }
